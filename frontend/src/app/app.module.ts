...
import { ClientListTicketsComponent } from './components/client/client-tickets/client-list-tickets/client-list-tickets.component';
import { AdminFullPageComponent } from './components/admin/admin-full-page/admin-full-page.component';
import { AdminAllPromotersComponent } from './components/admin/admin-all-promoters/admin-all-promoters.component';
import { AdminPendingPromotersComponent } from './components/admin/admin-pending-promoters/admin-pending-promoters.component';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { BuyTicketComponent } from './components/event/dialogs/buy-ticket/buy-ticket.component';
import { AdminChangePasswordComponent } from './components/admin/admin-change-password/admin-change-password.component';
import { SubmitCovidTestComponent } from './components/client/dialogs/submit-covid-test/submit-covid-test.component';
...
@NgModule({
  declarations: [
    ...
    ClientFullPageComponent,
    ClientViewProfileComponent,
    ClientListTicketsComponent,
    AdminFullPageComponent,
    AdminAllPromotersComponent,
    AdminPendingPromotersComponent,
    BuyTicketComponent,
    AdminChangePasswordComponent,
    SubmitCovidTestComponent,
    ClientTicketsComponent,
    ClientCovidTestsComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
